...
<body style="margin-left: 10px; margin-right:10px; padding: 10px;">
   ...
   <section class="about">
      ...
      <div class="row">
         ...
         <div class="content">
            <h3>why choose us?</h3>
            <p>We ensure the best service to our customers. Fresh and delicious food with fastest delivery reflect our dedication.</p>
